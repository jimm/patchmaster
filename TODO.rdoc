...
* Extract cursor out of PatchMaster.

* Triggers should be able to run any Ruby code, just like filters. Maybe
  create a new "pm" method for DSL that exposes PM::Patchmaster.instance.

* Rename InputInstrument#gets_data to InputInstrument#process_messages

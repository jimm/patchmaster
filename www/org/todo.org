...
- In the =connection= statement, shouldn't need to specify anything if input
  channel is =nil=. "connection :in_sym, :out_sym, 1" should be same as
  "connection :in_sym, nil, :out_sym, 1".

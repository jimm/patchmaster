...
Any MIDI message can /trigger/ an action such as moving to the next or
...
PatchMaster is by [[mailto:jim@jimmenard.com][Jim Menard]]. It is a rewrite of [[http://jimmenard.com/projects/keymaster/][KeyMaster]].
...
- All about [[file:patches.org][patches]] --- what happens when they run

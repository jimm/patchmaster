...
* {midi-eye}[https://github.com/arirusso/midi-eye] gem, which in turn
  requires (and will install automatically):
  * {midi-message}[https://github.com/arirusso/midi-message] gem.
  * {nibbler}[https://github.com/arirusso/nibbler] gem.
...
Input MIDI messages can trigger behaviors.
